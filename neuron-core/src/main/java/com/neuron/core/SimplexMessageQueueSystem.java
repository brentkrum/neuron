...
public final class SimplexMessageQueueSystem extends MessageQueueSystemBase
{
	...
	public static void defineQueue(String queueName, ObjectConfig queueConfig, ISimplexMessageQueueReaderCallback callback) {
		MessageQueueSystemBase.defineQueue(queueName, queueConfig, (msg) -> {
			callback.onData(msg);
			return null;
		});
	}
	 ...
	 *  
	 */
	public static boolean submitToQueue(String declaringNeuronInstanceName, String queueName, ReferenceCounted msg, ISimplexMessageQueueSubmissionListener listener) {
	...
	private static class Registrant implements INeuronApplicationSystem {
		...
		{
			return "SimplexMessageQueueSystem";
		}
